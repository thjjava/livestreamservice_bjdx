...
public interface ISensitiveWordService {
     ...
     * @return
     */
	public List<SensitiveWord> getResultList(String wherejpql,LinkedHashMap<String, String> orderby, Object... queryParams);
	
	/**
	 * 分页信息查询
	 * */
	public QueryResult<SensitiveWord> getScrollData(int firstindex,int maxresult, String wherejpql, Object[] queryParams,
